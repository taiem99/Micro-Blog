...
public class Route {
    ...
    public static final String USER_DETAILS = "user.html";

    public static final String REGISTRATION = "register.html";
    public static final String REGISTRATION_SUCCESS = "register_success.html";
}
